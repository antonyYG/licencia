...
<head>
    ...
    <!-- Recursos locales de datos (rutas relativas correctas) -->
    <script src="data/line.js"></script>
    <script src="data/point.js"></script>
    <script src="data/polygon.js"></script>
    <!-- Se elimina nepaldata.js porque no existe en view/data -->
...
<body>
    ...
    // Crea un nuevo mapa centrado en Chilca (coordenadas exactas) y con zoom
    var mymap = L.map('map').setView([-12.08673, -75.20785], 15);

    // Añade capa base OpenStreetMap con atribución correcta
