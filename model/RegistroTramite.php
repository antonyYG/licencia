...
class RegistroTramite extends conexion
{
	...
	public function listartramite(){
		...
		$sql=mysqli_query($con, "SELECT l.idlicencia,l.exp_num,l.idtienda,t.numruc,l.nombre_comercial,l.vigencia_lic,l.fecha_ingreso,l.fecha_expedicion,l.condicion,l.tipo_lic,l.NumResITSE,l.EstadoITSE,expedicionITSE,vigenciaITSE, l.nivel_riesgo FROM `licencia` l INNER JOIN tienda t ON l.idtienda = t.idtienda");
		return $sql;
	}
